                    ...
                    <div class="col-6 mt-2">
                     ...
                     <div class="col-6 mt-2">
                         <label for="state" class="form-label">State :</label><br>
                          ...
                          <input type="text" id="state" class="form-control{{$errors->first('state')?'input-error':''}}"  value="{{old('state','Maharashtra')}}"  name="state" required>
                     ...
                     <div class="col-6 mt-2">
                        ...
                        <input type="text" id="gstNo" class="form-control{{$errors->first('gstNo')?'input-error':''}}"  value="{{old('gstNo',27)}}" placeholder="Enter Company GST Number" name="gstNo" pattern="^[0-9]{2}[A-Z]{5}[0-9]{4}[0-9A-Z]{4}$" maxlenth="15" required>
