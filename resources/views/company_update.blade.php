            ...
            <form action="{{route('update_company_details',$company->id)}}" class="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-12 mt-1">
                     ...
                     <div class="col-12 mt-2">
                         ...
                         <textarea name="companyAddress" id="companyAddress" row="5" class="form-control w-50 p-1 {{$errors->first('companyAddress')?'input-error':''}}"  placeholder="Enter Company Address">{{old('companyAddress',$company->company_address)}}</textarea>
                    ...
                    <div class="col-12 mt-1">
                     ...
                     <div class="col-6 mt-2">
                        ...
                        <input type="text" id="gstNo" class="form-control{{$errors->first('gstNo')?'input-error':''}}"  value="{{old('gstNo',$company->gst_no)}}" placeholder="Enter Company GST Number" name="gstNo" pattern="^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}Z[0-9A-Z]{1}$" maxlenth="15" required>
                    </div> 
                    <div class="col-12 mt-1">
                         <span class="text-danger">
                            @error('gstNo')
                     ...
                     <div class="col-6 mt-2">
                        ...
                        <input type="date" id="date" class="form-control"  value="{{old('date', date('Y-m-d'))}}"  name="date" readonly>
                    </div> 
                    <div class="col-12 mt-1">
                         <span class="text-danger">
                            @error('date')
